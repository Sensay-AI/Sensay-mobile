...
You can learn more about navigators [in the Navigation docs] (./Navigation.md see on original link).
...
When updating the template files, please note that names must stay the same as well as the size (1024x1024px). A Sketch template file can be found here (see on remote github) - just make your changes, hide the grids, then click File -> Export.
...
You should feel free to make the provided templates your own! Just update the files in the `./ignite/templates/*` folders, and any generated files will then use your updated files. Read more in the Generator Templates (see on original repo) documentation.
...
Read more about making your own generators in the Generator Templates (see on original repo) documentation.
